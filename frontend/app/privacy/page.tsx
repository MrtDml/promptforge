          ...
          {[
            {
              ...
              content: [
                ...
                },
                {
                  ...
                  text: "Payments are processed by iyzico. We do not store your credit card number or sensitive payment details on our servers. We only retain subscription status and plan information.",
                },
                {
            ...
            },
            {
              ...
              content: [
                ...
                },
                {
                  ...
                  text: "Railway (infrastructure hosting), Vercel (frontend hosting), Anthropic (AI processing for code generation), iyzico (payment processing). Each provider has their own privacy policy.",
                },
              ],
            },
            {
